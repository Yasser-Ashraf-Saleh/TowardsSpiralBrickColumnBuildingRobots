function [color_heightmap, depth_heightmap, surface_pts, color_pts, rsurface_pts, rcolor_pts, ts] = get_heightmap(color_img, depth_img, cam_intrinsics, cam_pose, workspace_limits, heightmap_resolution)
...
%     size(surface_pts)
    ...
    r =zeros(heightmap_size); g =zeros(heightmap_size); b =zeros(heightmap_size);
